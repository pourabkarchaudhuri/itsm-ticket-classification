...
model_sub_category1 = pickle.load(
    open(
        os.path.join(__location__, "sub_category1.model"), "rb"
    )
)
...
def predictall():
    ...
    predicted_sub_category1 = model_sub_category1.predict([description])[0]
    print("predicted urgency: "+str(predicted_sub_category1))
